...
class LYWaveTouchButton: UIButton {
    ...
    var loopCount: Int {
        return Int(animationDuration / 0.01)
    }
    ...
    override init(frame: CGRect) {
        ...
        self.addTarget(self, action: #selector(self.touchedDown(sender:events:)), for: UIControl.Event.touchUpInside)
    }
...
//        self.hightLightColor = UIColor.randomColor
